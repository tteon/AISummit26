...
Usage:
  python scripts/report_interaction.py > docs/execplans/finbench-agent-interaction.md
"""
...
def main() -> None:
    ...
    print("## The questions\n")
    print("| id | audience | difficulty | question |")
    print("|---|---|---|---|")
    for q in run["questions"]:
        # The English wording is what the agent was actually given; the Korean gloss kept
        # alongside it in the data is provenance, not the prompt.
        print(f"| `{q['id']}` | {q['audience']} | {q['difficulty']} "
              f"| {q['question'].replace('{a}', 'N')} |")
